...
class MainActivity : AppCompatActivity() {
    ...
    // ✅ v1.5 새로운 Gate System (iOS 포팅)
    private lateinit var gateEvaluator: com.example.camera2app.ai.GateSystemEvaluator
    private lateinit var marginAnalyzer: com.example.camera2app.ai.MarginAnalyzer
    private lateinit var focalEstimator: com.example.camera2app.ai.FocalLengthEstimator
    private lateinit var feedbackGenerator: com.example.camera2app.ai.UnifiedFeedbackGenerator
...
//                groundingDino = GroundingDinoONNX(this)
                ...
                // ✅ 새로운 Gate System 초기화
                marginAnalyzer = com.example.camera2app.ai.MarginAnalyzer()
                focalEstimator = com.example.camera2app.ai.FocalLengthEstimator()
                gateEvaluator = com.example.camera2app.ai.GateSystemEvaluator()
                feedbackGenerator = com.example.camera2app.ai.UnifiedFeedbackGenerator.getInstance()

                Log.e("REALTIME_AI", "✅ tryAngleAnalyzer 초기화 완료")
                Log.e("GATE_SYSTEM", "✅ Gate System 초기화 완료 (GateEvaluator, MarginAnalyzer, FocalEstimator, FeedbackGenerator)")
